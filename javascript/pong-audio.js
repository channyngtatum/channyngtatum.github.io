...
export var wallSound = new soundFile("Wobble.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("Robot.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("ocean_waves.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("Shimmer.mp3");
